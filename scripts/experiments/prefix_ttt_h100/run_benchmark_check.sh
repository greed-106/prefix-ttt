...
#
#   scripts/experiments/prefix_ttt_h100/run_benchmark_check.sh <tag> [task] [extra prefix_ttt.lmms_run args...]
#   GPU=6 scripts/experiments/prefix_ttt_h100/run_benchmark_check.sh opt-1-3 pope
#
...
"$(command -v uv)" run --locked python \
    scripts/experiments/prefix_ttt_h100/compare_eval_runs.py \
